...
published:
created: 2026-05-06
description: "Use event sourcing, which persists aggregates as a sequence of domain events"
tags:
  - clippings
  - "vault-scout"
  - "source:tier2"
...
It is built using Eventuate, which is an application platform based on event sourcing and CQRS.
...
As a result, the application must use Command Query Responsibility Segregation (CQRS) to implement queries.
