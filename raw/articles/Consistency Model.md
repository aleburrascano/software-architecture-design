...
created: 2026-05-06
description: "In computer science, a consistency model specifies a contract between the programmer and a system, wherein the system guarantees that if the programmer follows the rules for operations on memory, memory will be consistent and the results of reading, writing, or updating memory will be predictable. Consistency models are used in distributed systems like distributed shared memory systems or distributed data stores (such as filesystems, databases, optimistic replication systems or web caching). Con"
tags:
  - clippings
  - "vault-scout"
  - "source:tier2"
...
Strong consistency models[edit]
...
Pipelined RAM consistency, or FIFO consistency[edit]
...
A value written by a process on a data item X will always be available to a successive read operation performed by the same process on data item X.[4]
...
Weak memory consistency models[edit]
...
Relaxed memory consistency models[edit]
...
Relaxed write to read and write to write[edit]
...
Relaxing read and read to write program orders: Alpha, RMO, and PowerPC[edit]
...
Transactional memory models[edit]
...
Other consistency models[edit]
Some other consistency models are as follows:

Causal+ consistency[21][22]
Cross-Client Monotonicity[23]
Delta consistency
Fork consistency
...
Consistency and replication[edit]
...
Data-centric consistency models[edit]
...
Consistent ordering of operations[edit]
...
Client-centric consistency models[edit]
...
Replicated-write protocols[edit]
...
Cache-coherence protocols[edit]
...
Distributed shared memory – Computer memory architecture
Non-uniform memory access – Computer memory design used in multiprocessing


^ Mark D. Hill (August 1998). "Multiprocessors Should Support Simple Memory Consistency Models". IEEE Computer. 31 (8): 28–34. Bibcode:1998Compr..31h..28H. doi:10.1109/2.707614.

^ a b Todd Lipcon (2014-10-25). "Design Patterns for Distributed Non-Relational Databases" (PDF). Archived from the original (PDF) on 2014-11-03. Retrieved 2011-03-24. A consistency model determines rules for visibility and apparent order of updates. Example: * Row X is replicated on nodes M and N * Client A writes row X to node N * Some period of time t elapses. * Client B reads row X from node M * Does client B see the write from client A? Consistency is a continuum with tradeoffs

^ a b Lamport, Leslie (Sep 1979). "How to make a multiprocessor computer that correctly executes multiprocess programs". IEEE Transactions on Computers. C-28 (9): 690–691. Bibcode:1979ITCmp.100..690L. doi:10.1109/TC.1979.1675439. S2CID 5679366. [open access through Lamport's website]

^ a b c d e f g h i j k l m n o p q r s t u v Tanenbaum, Andrew; Maarten Van Steen (2007). "Distributed systems". Pearson Prentice Hall.

^ a b Sarita V. Adve; Kourosh Gharachorloo (December 1996). "Shared Memory Consistency Models: A Tutorial" (PDF). IEEE Computer. 29 (12): 66–76. Bibcode:1996Compr..29l..66A. CiteSeerX 10.1.1.36.8566. doi:10.1109/2.546611. Archived from the original (PDF) on 2008-09-07. Retrieved 2008-05-28.
...
^ Shaz Qadeer (August 2003). "Verifying Sequential Consistency on Shared-Memory Multiprocessors by Model Checking". IEEE Transactions on Parallel and Distributed Systems. 14 (8): 730–741. arXiv:cs/0108016. Bibcode:2003ITPDS..14..730Q. doi:10.1109/TPDS.2003.1225053. S2CID 1641693.

^ a b Hutto, Phillip W.; Mustaque Ahamad (1990). "Slow memory: Weakening consistency to enhance concurrency in distributed shared memories". Proceedings.,10th International Conference on Distributed Computing Systems. IEEE. pp. 302–309. doi:10.1109/ICDCS.1990.89297. ISBN 978-0-8186-2048-5. S2CID 798676.

^ a b "Memory Consistency Models" (PDF). Archived from the original (PDF) on 2016-03-03. Retrieved 2016-11-17.
...
^ Collin Cusce.
"SALT: A Descriptive Model For Blockchain" Archived 2020-08-03 at the Wayback Machine.
2018.
...
^ Ganesan, Aishwarya; Alagappan, Ramnatthan; Arpaci-Dusseau, Andrea; Arpaci-Dusseau, Remzi (2020). "Strong and Efficient Consistency with Consistency-Aware Durability" (PDF). 18th USENIX Conference on File and Storage Technologies (FAST 20).
...
Yelick, Katherine; Bonachea, Dan; Wallace, Charles (2004), A Proposal for a UPC Memory Consistency Model, v1.0 (PDF), Lawrence Berkeley National Lab Tech Report, doi:10.2172/823757, OSTI 823757, LBNL-54983, archived from the original (PDF) on 20 May 2005
...
Sarita V. Adve; Kourosh Gharachorloo (December 1996). "Shared Memory Consistency Models: A Tutorial" (PDF). IEEE Computer. 29 (12): 66–76. Bibcode:1996Compr..29l..66A. CiteSeerX 10.1.1.36.8566. doi:10.1109/2.546611. Archived from the original (PDF) on 2008-09-07. Retrieved 2008-05-28.
